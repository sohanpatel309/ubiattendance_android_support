...
//print(date);
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: (filests==true)?loader():new ListView(
        physics: NeverScrollableScrollPhysics(),
        children: <Widget>[
          SizedBox(height:3.0),
          new Container(
            padding: EdgeInsets.only(top: 10.0),
            child: Center(child:Text(widget.dname,style: TextStyle(fontSize: 22.0,color: Colors.black54,),),),
          ),
          new Container(
            padding: EdgeInsets.only(bottom: 12.0),
            child: Center(child:Text(widget.date,style: TextStyle(fontSize: 16.0,color: Colors.black54,),),),
          ),
          /*  Container(
                  ...
                  child: new ListTile(
                    ...
                    Container( height: MediaQuery.of(context).size.height*.60,
                      ...
                      child: new FutureBuilder<List<Attn>>(
                        future: getCDateAttnDeptWise('present',widget.date , widget.departid),
                        builder: (context, snapshot) {
                          if (snapshot.hasData) {
                                          ...
                                          Row(
                                              children: <Widget>[
                                                ...
                                                Container(
                                                  ...
                                                  child: Text("Total Present: ${countP} Out of ${widget.total}",style: TextStyle(color: Colors.orange,fontWeight: FontWeight.bold,fontSize: 16.0,),),
                                                ),
                ...
                new Container(
                  ...
                  child: new ListTile(
                    ...
                    Container( height: MediaQuery.of(context).size.height*.60,
                      ...
                      //////////////////////////////////////////////////////////////////////---------------------------------
                      child: new FutureBuilder<List<Attn>>(
                        future: getCDateAttnDeptWise('absent',widget.date , widget.departid),
                        builder: (context, snapshot) {
                          if (snapshot.hasData) {
                            /* SchedulerBinding.instance.addPostFrameCallback((_) => setState(() {
                                      ...
                                      children: <Widget>[
                                        ...
                                        Row(
                                            children: <Widget>[
                                              ...
                                              Container(
                                                padding: EdgeInsets.only(left: 5.0),
                                                child: Text("Total Absent: ${countA}  Out of ${widget.total}",style: TextStyle(color: Colors.orange,fontWeight: FontWeight.bold,fontSize: 16.0,),),
                                              ),
                                              Container(
                                                padding: EdgeInsets.only(left: 5.0),
                                                child: InkWell(
                ...
                new Container(
                  ...
                  child: new ListTile(
                    ...
                    Container( height: MediaQuery.of(context).size.height*.60,
                      ...
                      //////////////////////////////////////////////////////////////////////---------------------------------
                      child: new FutureBuilder<List<Attn>>(
                        future: getCDateAttnDeptWise('latecomings',widget.date , widget.departid),
                        builder: (context, snapshot) {
                          if (snapshot.hasData) {
                            /* SchedulerBinding.instance.addPostFrameCallback((_) => setState(() {
                ...
                new Container(
                  ...
                  child: new ListTile(
                    ...
                    Container( height: MediaQuery.of(context).size.height*.60,
                      ...
                      //////////////////////////////////////////////////////////////////////---------------------------------
                      child: new FutureBuilder<List<Attn>>(
                        future: getCDateAttnDeptWise('earlyleavings',widget.date , widget.departid),
                        builder: (context, snapshot) {
                          if (snapshot.hasData) {
                            /* SchedulerBinding.instance.addPostFrameCallback((_) => setState(() {
