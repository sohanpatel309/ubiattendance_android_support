    ...
    return Container(
      ...
      child:ListView(
        ...
        children: <Widget>[
          ...
          Center(
            child:Text('Employee & Admin Guide',
          ...
          child:SizedBox(
                  child: new Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                      Text("4. Time In will be punched successfully."),
                     // SizedBox(height: 5.0,),
                    ],
                  )
              ),
          ...
          child:SizedBox(
              child: new Column(
                ...
                Text("The punch Visit feature is used for on field employees - those who visit clients/ sites / offices",style: TextStyle(fontWeight: FontWeight.bold),),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    1. Field employees should ensure that the GPS is turned on"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    2. Employees should click on “Visits” from Home screen"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    3. Click on “Add” button"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    4. To Punch your time click “Visit In” & fill details about the visit"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    5. To punch your Visit's out time click “Visit out”"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
          ...
          child:SizedBox(
              child: new Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    3. Enter your old password & then enter the new password"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
        ...
        new AnimatedContainer(duration: const Duration(milliseconds: 5),
          child:SizedBox(
              ...
              Text("Admin can configure Shifts, Departments and Designations through the “Settings”",style: TextStyle(fontWeight: FontWeight.bold),),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    1. Click on “Shifts” to manage and add shifts"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    2. Click on “Departments” to manage departments and add new departments"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    3. Click on “Designations” to manage & add designations"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    4. Click on “Employees” to add and manage the employees"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    5. “Change Password” is to update your password"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
        ...
        new AnimatedContainer(duration: const Duration(milliseconds: 5),
          child:SizedBox(
              child: new Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text('Going with admin login first go to "settings" then click "employee" to register the employee. ',style: TextStyle(fontWeight: FontWeight.bold),),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    1. Enter first name & last name"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    2. Enter employee's email(optional)"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    3. Select a country from the menu"),
             //     Text("    (Country code will automatically get selected)"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    4. Enter employee's Phone No. "),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text('    5. The preset password "123456" will appear. '),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
          ...
          child:SizedBox(
              child: new Column(
                ...
                Text("Admin can view Time off requests of each employee",style: TextStyle(fontWeight: FontWeight.bold),),
                  ...
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    2. Click on “Time Off” Report fom the Reports list."),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    3. Check Employee's time off with custom date"),
                ],
              )
          ),
        ...
        new AnimatedContainer(duration: const Duration(milliseconds: 5),
          ...
          child:SizedBox(
              child: new Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                Text("The Punch Visit feature is used for Field employees - those who visit clients/ sites / offices",style: TextStyle(fontWeight: FontWeight.bold),),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    1. The field employees should ensure that the GPS is turned on"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    2. The should click on “Visits” from the Home screen"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    3. Click “Add” button"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    4. To Punch your Visit Time In, click “Visit In” & fill details about the visit"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
